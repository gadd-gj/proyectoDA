 ...
 * @author gusky
 */
public class RestClientDepartamentos {
    private WebTarget webTarget;
   
    private Client client;
    private static final String BASE_URI = "http://172.17.0.4:8080/uv/departamentos";

    public RestClientDepartamentos() {
    ...
    public List<Departamento> getJson(List<Departamento> responseType) throws ClientErrorException {
